...
public class cpp11_using_typedef_template_member_runme {
  ...
  private static OwnersInt makeOwners() {
  ...
  public static void main(String argv[]) {
    ...
    NodeIInt base = new NodeIInt();
    base.setOwners(makeOwners());
    check(base.getOwners().getValue(), 42);
